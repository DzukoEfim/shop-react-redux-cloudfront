...
export const handlers = [
  rest.get(`${API_PATHS.products}/product`, (req, res, ctx) => {
    return res(ctx.status(200), ctx.delay(), ctx.json<Product[]>(products));
  }),
  rest.put(`${API_PATHS.products}/product`, (req, res, ctx) => {
    return res(ctx.status(200));
  }),
  rest.delete(`${API_PATHS.products}/product/:id`, (req, res, ctx) => {
    return res(ctx.status(200));
  }),
  rest.get(`${API_PATHS.products}/product/available`, (req, res, ctx) => {
    return res(
      ctx.status(200),
      ctx.delay(),
  ...
  rest.get(`${API_PATHS.products}/product/:id`, (req, res, ctx) => {
